...
use Amphibee\Plugin\FrontendAccount\Providers\ForgottenPasswordProvider;
use Amphibee\Plugin\FrontendAccount\Providers\FrontendAccountOptionPage;
use Amphibee\Plugin\FrontendAccount\Providers\RouteServiceProvider;
...
return [
    ...
    */
    'autoloading' => [
        'Amphibee\\Plugin\\FrontendAccount\\' => 'resources',
    ],
    ...
    */
    'providers' => [
        ...
        FrontendAccountOptionPage::class,
        ForgottenPasswordProvider::class,
    ],
